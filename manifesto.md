...
This distinction mattered in my own pipeline. Repeated horizontal audit passes continued to find defects, but an increasing share came from the previous pass's own edits. By pass 6, 10 of 13 findings were self-inflicted. A vertical pass over one capability found missing layers the document-to-document comparisons could not represent. I didn't need another careful reading. I needed a different axis. [E2](https://github.com/ssheleg/task-pipeline/blob/17ef1a6346384094455ae3fa0ffadf790b586d83/plugins/task-pipeline/skills/task-pipeline/references/audit.md#L44-L64)
